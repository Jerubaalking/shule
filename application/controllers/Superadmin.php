...
class Superadmin extends CI_Controller {
  ...
  public function driver($param1 = '', $param2 = ''){
    ...
    if($param1 == 'create'){
      $response = $this->user_model->driver_create();
      echo $response;
    }
    ...
    // show data from database
    if ($param1 == 'list') {
      $this->load->view('backend/superadmin/driver/list');
    }
...
// START BUS-ROUTE SECTION
public function bus_routes($param1='', $param2='')
{
  if(empty($param1)){
    $page_data['working_page'] = 'filter';
    $page_data['folder_name'] = 'bus_routes';
    $page_data['page_title'] = 'Bus Routes';
    $this->load->view('backend/index', $page_data);
  ...
  //create to database
  if($param1 == 'create'){
    $response = $this->crud_model->add_bus_route();
    echo $response;
  }

  if ($param1 == 'list') {
    $this->load->view('backend/superadmin/bus_routes/list');
  }
  if($param1 == 'edit'){
    $page_data['id'] = $param2;
    $page_data['working_page'] = 'edit';
    $page_data['folder_name'] = 'bus_routes';
    $page_data['page_title'] = 'update_bus_route';
    $this->load->view('backend/index', $page_data);
  }
  if($param1 == 'updated'){
      $response = $this->crud_model->update_bus_route($param2);
      echo $response;
  }
  
  if($param1 == 'delete'){
    $response = $this->crud_model->delete_bus_route($param2);
    echo $response;
  }
}
...
// START BONUS SECTION
public function bonuses($param1='', $param2='')
{
  if(empty($param1)){
    $page_data['working_page'] = 'filter';
    $page_data['folder_name'] = 'bonuses';
    $page_data['page_title'] = 'Bonuses';
    $this->load->view('backend/index', $page_data);

  }
  //create to database
  if($param1 == 'create'){
    $response = $this->crud_model->add_bonus();
    echo $response;
  }

  if ($param1 == 'list') {
    $this->load->view('backend/superadmin/bonuses/list');
  }
  if($param1 == 'edit'){
    $page_data['id'] = $param2;
    $page_data['working_page'] = 'edit';
    $page_data['folder_name'] = 'bonuses';
    $page_data['page_title'] = 'update_bonus';
    $this->load->view('backend/index', $page_data);
  }
  if($param1 == 'updated'){
      $response = $this->crud_model->update_bonus($param2);
      echo $response;
  }
  
  if($param1 == 'delete'){
    $response = $this->crud_model->delete_bonus($param2);
    echo $response;
  }
}
...
// START ACADEMIC REPORT SECTION
public function academics($param1='', $param2='', $date_from = "", $date_to = "", $selected_user = "", $selected_status = "")
{
  if(empty($param1)){
    $page_data['working_page'] = 'filter';
    $page_data['folder_name'] = 'reports/academics';
  ...
  if ($param1 == 'list') {
    $date = explode('-', $this->input->post('selectedValue'));
    $data['date_from'] = strtotime($date[0].' 00:00:00');
    $data['date_to']   = strtotime($date[1].' 23:59:59');
    $data['user_id'] = $this->input->post('selectedUser');
    if(!$data['user_id']){
      echo 'Please select a student';
    }else{
      $this->load->view('backend/superadmin/reports/academics/list', $data, false);
    }
  }
  ...
  if ($param1 == 'url') {
    ...
    $selected_user = $this->input->post('selectedUser');
    $selected_status = $this->input->post('selectedStatus');
    echo route('export/'.$type.'/'.$date_from.'/'.$date_to.'/'.$selected_user.'/'.$selected_status);
  }
  // EXPORT AS PDF
  if($param1 == 'pdf' || $param1 == 'print') {
    ...
    $page_data['selected_user'] = $selected_user;
    $page_data['selected_status'] = $selected_status;
    $html = $this->load->view('backend/superadmin/reports/academics/reports',$page_data, true);
...
public function report($param1 = "", $date_from = "", $date_to = "", $selected_user = "", $selected_status = "") {
  //RETURN EXPORT URL
  if ($param1 == 'url') {
    $type = $this->input->post('type');
    $date = explode('-', $this->input->post('dateRange'));
  ...
  if($param1 == 'pdf' || $param1 == 'print') {
    ...
    $page_data['selected_user'] = $selected_user;
    $page_data['selected_status'] = $selected_status;
    $html = $this->load->view('backend/superadmin/reports/academics/export',$page_data, true);
...
// END ACADEMIC REPORT SECTION

// START SALARY SECTION
public function salary($param1='', $param2='')
{
  if(empty($param1)){
    $page_data['working_page'] = 'filter';
    $page_data['folder_name'] = 'salary';
  ...
  //create to database
  if($param1 == 'create'){
    $response = $this->crud_model->add_salary();
    echo $response;
  }

  if ($param1 == 'list') {
    $this->load->view('backend/superadmin/salary/list');
  }
  if($param1 == 'edit'){
    $page_data['id'] = $param2;
    $page_data['working_page'] = 'edit';
    $page_data['folder_name'] = 'salary';
    $page_data['page_title'] = 'update_salary';
    $this->load->view('backend/index', $page_data);
  }
  if($param1 == 'updated'){
      $response = $this->crud_model->update_salary($param2);
      echo $response;
  }
  
  if($param1 == 'delete'){
    $response = $this->crud_model->delete_salary($param2);
    echo $response;
  }
}
...
public function deductions($param1='', $param2='')
{
  if(empty($param1)){
    $page_data['working_page'] = 'filter';
    $page_data['folder_name'] = 'deductions';
    $page_data['page_title'] = 'Deductions';
    $this->load->view('backend/index', $page_data);

  }
  //create to database
  if($param1 == 'create'){
    $response = $this->crud_model->add_deduction();
    echo $response;
  }

  if ($param1 == 'list') {
    $this->load->view('backend/superadmin/deductions/list');
  }
  if($param1 == 'edit'){
    $page_data['id'] = $param2;
    $page_data['working_page'] = 'edit';
    $page_data['folder_name'] = 'deductions';
    $page_data['page_title'] = 'update_deduction';
    $this->load->view('backend/index', $page_data);
  }
  if($param1 == 'updated'){
      $response = $this->crud_model->update_deduction($param2);
      echo $response;
  }
  
  if($param1 == 'delete'){
    $response = $this->crud_model->delete_deduction($param2);
    echo $response;
  }
}
...
public function vehicle($param1='', $param2=''){
  ...
  //create to database
  if($param1 == 'create'){
      $response = $this->crud_model->add_vehicle();
      echo $response;
  }
    
  if ($param1 == 'list') {
    $this->load->view('backend/superadmin/vehicle/list');
  }
  // form view
  if($param1 == 'edit'){
    $page_data['id'] = $param2;
    $page_data['working_page'] = 'edit';
    $page_data['folder_name'] = 'vehicle';
    $page_data['page_title'] = 'update_vehicle';
    $this->load->view('backend/index', $page_data);
  }
  if($param1 == 'updated'){
...
// END TRANSPORTATION section
  ...
  //START IDENTITY CARDS section
  public function identity_cards($param1 = '',$param2 = '',$param3 = ''){

    // if($param1 == 'filter'){
    //   //ID view
    //     // $page_data['aria_expand'] = 'single';
    //     $page_data['working_page'] = 'id_template';
    //     $page_data['folder_name'] = 'identity_cards';
    //     $page_data['page_title'] = 'ID Template';
    //     $this->load->view('backend/index', $page_data);
    //   }
    ...
    if(empty($param1)){
      $page_data['working_page'] = 'filter';
      $page_data['folder_name'] = 'identity_cards';
      $page_data['page_title'] = 'identity_cards';
      $this->load->view('backend/index', $page_data);
    }
    ...
    if($param1 == 'filter'){
      $page_data['class_id'] = $param2;
      $page_data['section_id'] = $param3;
      $this->load->view('backend/superadmin/identity_cards/id_template', $page_data);
    }
    if(empty($param1)){
      // $page_data['class_id'] = $param2;
      // $page_data['section_id'] = $param3;
