...
?>
    <form method="POST" class="d-block ajaxForm" action="<?php echo route('driver/update/'.$param1); ?>">
        <div class="form-row">
            ...
            <div class="form-group col-md-12">
                <label for="nida"><?php echo get_phrase('nida'); ?></label>
                <input type="text" value="<?php echo $user['nida']; ?>" class="form-control" id="nida" name = "nida" >
                <small id="" class="form-text text-muted"><?php echo get_phrase('provide_nida_number'); ?></small>
            </div>
