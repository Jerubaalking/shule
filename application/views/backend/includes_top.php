...
<link href="<?php echo base_url(); ?>assets/backend/fonts/fontkiko/css/kiko-all.css" rel="stylesheet" type="text/css" />
<link href="<?php echo base_url(); ?>assets/backend/fonts/fontkiko/css/kiko-all.min.css" rel="stylesheet" type="text/css" />
...
<link href="<?php echo base_url(); ?>assets/backend/js/barcode/style.css" rel="stylesheet" type="text/css" />
...
<!--Jquery-->
<script src="<?php echo base_url(); ?>assets/backend/js/jquery-3.6.0.js"></script>
